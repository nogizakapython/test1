    ...
    if w_month == 1 and w_day <= 12:
        for url in [target_url1,target_url2]:
            ...
            for i in range(1,16):
                try:
                    # xpathの修正(2025/2/6)
                    xpath_str1 = '/html/body/div[2]/div[2]/div/div/div/div/div/div/div[2]/div/div[2]/div/div/div/div[2]/div/div[1]/div/div/div/div/div/div/div/table/tbody/tr[' + str(i) + ']/td[1]'
                    element_str1 = driver.find_element(by=By.XPATH,value=xpath_str1)
                    print(element_str1.get_attribute("outerHTML"),file=codecs.open(file_name,'a','utf-8'))
                    xpath_str2 = '/html/body/div[2]/div[2]/div/div/div/div/div/div/div[2]/div/div[2]/div/div/div/div[2]/div/div[1]/div/div/div/div/div/div/div/table/tbody/tr[' + str(i) + ']/td[2]/a'
