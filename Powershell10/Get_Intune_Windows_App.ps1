...
# ArrayListの定義
$ID_LIST = [List[String]]@('M_28a08cc6-111b-492f-8c28-860f481fe2d4')

#出力ファイルの定義
$result_file = "C:\work\20210830\result\Intune_Windows_App.txt"
...
function command($line) {
    Get-IntuneAppProtectionPolicyAndroidApp -androidManagedAppProtectionId $line | Format-List | Out-File $result_file -Append
    return_code($?)
}
