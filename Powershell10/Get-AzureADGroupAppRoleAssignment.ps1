##### Azureアプリケーションロール(グループ)のアサイン状況確認 #####
...
# ArrayListの定義
$ID_LIST = [List[String]]@('61dd4f60-838d-456d-a108-abb5c949b2bd')

#出力ファイルの定義
$result_file = "C:\work\20210909\result\Get-AzureADGroupAppRoleAssignment.txt"
...
function command($line) {
    Get-AzureADGroupAppRoleAssignment -ObjectId $line | Format-List | Out-File $result_file -Append
    return_code($?)
}
