...
#出力ファイルの定義
$result_file = "C:\work\20210825\result\Get-DeviceManagement_deviceEnrollmentConfigurations.txt"
#メッセージの定義
$msg1 = "OK"
$msg2 = "NG"
...
#####コマンド実行メソッド
function command {
    Get-DeviceManagement_DeviceEnrollmentConfigurations | Format-List | Out-File $result_File
    return_code($?)
}
