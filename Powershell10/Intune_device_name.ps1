###### 　　Intune   デバイスのみの情報取得スクリプト
######     Create Date   2021/8/23
######     Create Author  T.HATTORI
###出力先ファイルの定義
$result_file = "C:\work\20210823\result\Intune_device_name.txt"
###出力先ファイルの行数
$count = 0
###標準出力のメッセージ定義
$msg1 = "リターンコードは正常です"
$msg2 = "リターンコードは異常です"
$msg3 = "Intuneのデバイス名ファイルの作成に成功しました"
$msg4 = "Intuneのデバイス名ファイルの作成に失敗しました"
...
#### コマンド実行メソッド
function command {
    Get-IntuneManagedDevice  -Select deviceName | Out-File $result_file
    return $?
}
####  リターンコードメソッド
