####  Intune  サービスパック適用履歴を取得するPowershell
####  Create  Date   2021/8/24
####  Create  Author  T.HATTORI

$result_file = "C:\work\20210824\result\Get_IntuneRoleDefinition.txt"
$msg1 = "OK"
$msg2 = "NG"
$msg3 = "ファイルの取得に成功しました"
$msg4 = "ファイルの取得に失敗しました"
...
#### コマンド実行メソッド
function command {
    Get-IntuneRoleDefinition | Format-List | Out-File $result_file
    return $?
}
