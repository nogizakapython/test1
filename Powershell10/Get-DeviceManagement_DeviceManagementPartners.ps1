######   Intune シングルテナント確認スクリプト##########
######   Create Date    2021/8/25             ##########
######   Create Author  T.HATTORI             ##########
########################################################

#出力ファイルの定義
$result_file = "C:\work\20210825\result\Get-DeviceManagement_DeviceManagementPartners.txt"
#メッセージの定義
$msg1 = "OK"
$msg2 = "NG"
...
#####コマンド実行メソッド
function command {
    Get-DeviceManagement_DeviceManagementPartners | Format-List | Out-File $result_File
    return_code($?)
}
