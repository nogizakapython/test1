...
file_name = "ritsumeikan" + date1 + ".txt"
out_file = "ritsumeikan.txt"
string1 = '<div id="sideCallouts">'
date_str = ""
w_title = ""
base_url = 'https://www.ritsumeikan-trust.jp'

target_url = 'https://www.ritsumeikan-trust.jp/info/notice/'
max_row = 5
...
try:
    ...
    for i in range(1,11):
        ...
        xpath_str1 = '//*[@id="g-wrapper"]/div/main/article/div[4]/div/div/div[' + str(i) + ']/ul/li'
        try:
        ...
        xpath_str2 = '//*[@id="g-wrapper"]/div/main/article/div[4]/div/div/div[' + str(i) + ']/ul/li/a'
...
#        result4 = re.search(key_word,w_title)
    ...
    if result2:
        ...
        w_array2 = line1.split(">")
        w_line = w_array2[1]
        w_line = w_line.replace('<img src="/common/images_t/common/icon_pdf_x2.png"',"")
        w_line = w_line.replace(' alt="PDF"',"")
        w_ymd = w_line
        #print(w_ymd)   

        wb = op.load_workbook(export_file)
        sh_name = 'RITSUMEIKAN UNIVERSITY'
        ws = wb[sh_name]
