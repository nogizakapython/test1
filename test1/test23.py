...
file_name = "nci" + date1 + ".txt"
out_file = "nci.txt"
string1 = '<div id="sideCallouts">'
date_str = ""
w_title = ""
base_url = 'https://www.nci.co.jp'

target_url = 'https://www.nci.co.jp/news/'
max_row = 5
...
try:
    ...
    for i in range(1,11):
        ...
        xpath_str1 = '/html/body/div/div[4]/div/div[2]/a[' + str(i) + ']'
        try:
            element_str1 = driver.find_element(by=By.XPATH,value=xpath_str1)
        except:
            break
        print(element_str1.get_attribute("outerHTML"),file=codecs.open(file_name,'a','utf-8'))
        xpath_str2 = '/html/body/div/div[4]/div/div[2]/a[' + str(i) + ']/p[1]'
        ...
        xpath_str3 = '/html/body/div/div[4]/div/div[2]/a[' + str(i) + ']/p[2]/span'
...
while True:
    ...
    if result3:
        ...
        if result4:
            ...
            sh_name = 'NCI SYSTEM INTEGRATION, INC.'
            ws = wb[sh_name]
