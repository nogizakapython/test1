...
try:
    ...
    sleep(5)
    try:
        element = driver.find_element(By.XPATH,'//*[@id="n-content"]/div/div[1]/p[2]')
    ...
    for i in range(1,21):
        xpath_str1 = '//*[@id="n-content"]/div/div[2]/div/ul/li[' + str(i) + ']/a'
        xpath_str2 = '//*[@id="n-content"]/div/div[2]/div/ul/li[' + str(i) + ']/a/p'
        xpath_str3 = '//*[@id="n-content"]/div/div[2]/div/ul/li[' + str(i) + ']/a/h3'
