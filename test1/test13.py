...
target_url = 'https://jccu.coop/info/newsrelease/#count2'
max_row = 5
...
try:
    ...
    for h in range(1,3):
        for i in range(1,20):
            ...
            xpath_str1 = '//*[@id="content"]/div[2]/div[' + str(h) + ']/div[' + str(i) + ']/dl/dt'
            try:
                element_str1 = driver.find_element(by=By.XPATH,value=xpath_str1)
            except:
                break
            print(element_str1.get_attribute("outerHTML"),file=codecs.open(file_name,'a','utf-8'))
            xpath_str2 = '//*[@id="content"]/div[2]/div[' + str(h) + ']/div[' + str(i) + ']/dl/dd/a'
...
while True:
    ...
    if result1:
        ...
        w_line = w_array1[1]
        w_line = w_line.replace('<br class="spElement"','')
