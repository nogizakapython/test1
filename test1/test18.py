...
file_name = "marle" + date1 + ".txt"
out_file = "marle.txt"
string1 = '<div id="sideCallouts">'
date_str = ""
w_title = ""
base_url = 'https://newsroom.mahle.com'

target_url = 'https://newsroom.mahle.com/press/ja/press-releases/'
max_row = 5
...
try:
    ...
    for i in range(1,51):
        ...
        xpath_str1 = '/html/body/div/div[2]/section[2]/div/a[' + str(i) + ']'
        try:
            element_str1 = driver.find_element(by=By.XPATH,value=xpath_str1)
        except:
            break
        print(element_str1.get_attribute("outerHTML"),file=codecs.open(file_name,'a','utf-8'))
        xpath_str2 = '/html/body/div/div[2]/section[2]/div/a[' + str(i) + ']/div[2]/div[1]/div'
        ...
        xpath_str3 = '/html/body/div/div[2]/section[2]/div/a[' + str(i) + ']/div[2]/h2'
...
while True:
    ...
    if result2:    
        ...
        w_line = w_array2[1]
        w_line = w_line.replace("</div","")
        w_array3 = w_line.split(".")
        w_y = w_array3[2]
        w_m = w_array3[1]
        w_d = w_array3[0]
        w_ymd = w_y + "/" + w_m + "/" + w_d       
    ...
    if result3:
        ...
        w_title = w_array3[1]
        w_title = w_title.replace("</h2","")
        #print(w_title)
        key_word = key_word = r"(Management|Board|to head)"
