...
driver.get('https://www.abbvie.co.jp/press-release/2023-news-archive.html')
...
while True:
    ...
    result5 = re.match("<p><a href",line1)
    if result4:
        line1 = line1.replace("    <h3>","")
        line1 = line1.replace("</h3>","")
        line1 = line1.replace("&nbsp;"," ")
        date_str = line1
        #print(date_str)
