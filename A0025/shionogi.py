...
input_file = "shionogi" + date1 + ".txt"
out_file = "shionogi.txt"
date_str = ""
w_title = ""
base_url = 'https://www.shionogi.com'
web_url = 'https://www.shionogi.com/jp/ja/news.html?nen='
max_row = 5
...
for year in [date5,date6]:
   ...
   try:
      ...
      for i in range(1,13):
         for j in range(1,5):
            try:
               xpath_str1 = '//*[@id="anc-month' + str(i) + '"]/div[' + str(j) + ']/div/div'
...
while True:
     ...
     result1 = re.search('section-tag__time',line1)
