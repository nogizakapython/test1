...
input_file = "shimano" + date1 + ".txt"
out_file = "shimano.txt"
date_str = ""
w_title = ""
base_url = 'https://www.shimano.com'
web_url = 'https://www.shimano.com/jp/ir/news/index.html'
max_row = 5
...
try:
   ...
   for i in range(1,31):
      try:
         xpath_str1 = '//*[@id="xj-mainlist"]/li[' + str(i) + ']/div/a'
