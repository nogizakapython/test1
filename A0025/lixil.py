...
input_file = "lixil" + date1 + ".txt"
out_file = "lixil.txt"
date_str = ""
w_title = ""
base_url = 'https://www.lixil.com/'
web_url = 'https://www.lixil.com/jp/investor/ir_news/'
max_row = 5
...
try:
   ...
   for i in range(1,21):
      try:
         xpath_str1 = '//*[@id="announcement"]/div/div[1]/section/div/ul/li[' + str(i) + ']'
...
while True:
   ...
   result2 = re.search('eirItem_title_link',line1) 
