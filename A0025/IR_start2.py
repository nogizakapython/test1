...
############  修正       2026/8/14  takao.hattori    途中から実行する場合の説明をコメントに追記
##################################################

# kessan_excel_copyと書かれている行の「#」は削除しないでください。
# 途中から実行する場合、検索済みの企業の行の文頭に「#」を入れてください
# 検索対象の企業の文頭に「#」がないことを確認してください。文頭に「#」がある場合、「#」を削除してください。
...
# kessan_excel_copyと書かれている行にある「#」を削除しないでください(2026/8/12 takao.hattori)
# 途中から実行する場合、検索済みの企業の行の文頭に「#」を入れてください
# 検索対象の企業の文頭に「#」がないことを確認してください。文頭に「#」がある場合、「#」を削除してください。
