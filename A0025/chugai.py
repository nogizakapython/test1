...
input_file = "chugai" + date1 + ".txt"
out_file = "chugai.txt"
date_str = ""
w_title = ""
base_url = 'https://www.chugai-pharm.co.jp'
web_url = 'https://www.chugai-pharm.co.jp/ir/past.html'
max_row = 5
...
try:
    ...
    for i in range(1,3):
        try:
            ...
            xpath_str1 = '//*[@id="mainContents"]/section[' + str(i) + ']/div/div/div/ul'
...
while True:
    ...
    if line1:
        ...
        break   
    result1 = re.search('listDate',line1)
