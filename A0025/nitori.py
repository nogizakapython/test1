...
input_file = "nitori" + date1 + ".txt"
out_file = "nitori.txt"
date_str = ""
w_title = ""
base_url = 'https://www.nitorihd.co.jp'
web_url = 'https://www.nitorihd.co.jp/ir/news/'
max_row = 5
...
for year in [date5,date6]:
    ...
    try:
       ...
       for i in range(1,26):
          try:
             xpath_str1 = '//*[@id="contents"]/dl/dt[' + str(i) + ']'
          ...
          xpath_str2 = '//*[@id="contents"]/dl/dd[' + str(i) + ']'
...
while True:
    ...
    if result2:
      ...
      #  print(w_url)
       ...
       title_array = w_titlestr.split("<")
       w_titlestr = title_array[0]
