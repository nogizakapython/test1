...
input_file = "toyotabosyoku" + date1 + ".txt"
out_file = "toyotabosyoku.txt"
date_str = ""
w_title = ""
base_url = 'https://www.toyota-boshoku.com'
web_url = 'https://www.toyota-boshoku.com/jp/ir/whatsnew/'
max_row = 5
...
try:
    ...
    for i in range(1,25):
        try:
            ...
            xpath_str1 = '//*[@id="anc-pagetop"]/div[3]/main/article/section/div/div/div/div[' + str(i) + ']'
