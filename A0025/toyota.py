...
input_file = "toyota" + date1 + ".txt"
out_file = "toyota.txt"
date_str = ""
w_title = ""
base_url = 'https://global.toyota'
web_url = 'https://global.toyota/jp/ir/?padid=ag478_from_header'
max_row = 5
...
try:
    ...
    for i in range(1,25):
        try:
            ...
            xpath_str1 = '//*[@id="contents"]/div/div/div/div[2]/div[1]/ul/li[' + str(i) + ']'
