...
file_name = "maruho" + date1 + ".txt"
out_file = "maruho.txt"
string1 = '<div id="sideCallouts">'
date_str = ""
w_title = ""
base_url = 'https://www.maruho.co.jp'

target_url = 'https://www.maruho.co.jp/information/'
max_row = 5
...
try:
    ...
    for i in range(1,51):
        ...
        xpath_str1 = '//*[@id="js-wrap"]/main/article/div[2]/article[' + str(i) + ']/div/time'
        try:
            element_str1 = driver.find_element(by=By.XPATH,value=xpath_str1)
        except:
            break
        print(element_str1.get_attribute("outerHTML"),file=codecs.open(file_name,'a','utf-8'))
        xpath_str2 = '//*[@id="js-wrap"]/main/article/div[2]/article[' + str(i) + ']/p/a'
...
#    result3 = re.match("<h2>",line1)
    ...
    if result2:
        ...
        w_url = w_array2[0]
        w_url = w_url.replace('<a class="p-information-top-news_link" href=',"")
