...
file_name = "ikedamohando" + date1 + ".txt"
out_file = "ikedamohando.txt"
string1 = '<div id="sideCallouts">'
date_str = ""
w_title = ""
base_url = 'https://www.ikedamohando.co.jp/'

target_url = 'https://www.ikedamohando.co.jp/topics.html'
max_row = 5
...
try:
    ...
    for i in range(1,50):
        ...
        xpath_str1 = '//*[@id="mainContent"]/div[2]/div[2]/dl/dt[' + str(i) + ']/p'
        ...
        xpath_str2 = '//*[@id="mainContent"]/div[2]/div[2]/dl/dd[' + str(i) + ']/a'
        try:
            ...
            str3 = "<h10>リンクなし</h10>"
            print(str3,file=codecs.open(file_name,'a','utf-8'))    
