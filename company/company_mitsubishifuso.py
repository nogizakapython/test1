...
file_name = "fuso" + date1 + ".txt"
out_file = "fuso.txt"
string1 = '<div id="sideCallouts">'
date_str = ""
w_title = ""
base_url = 'https://www.mitsubishi-fuso.com/'
target_url = 'https://www.mitsubishi-fuso.com/ja/news-main/press-release/' + date2 + "/"
max_row = 5
...
try:
    ...
    for i in range(1,81):
        ...
        xpath_str1 = '//*[@id="container"]/section[3]/ul/li[' + str(i) + ']/a'
