...
file_name = "kidzania" + date1 + ".txt"
out_file = "kidzania.txt"
string1 = '<div id="sideCallouts">'
date_str = ""
w_title = ""
base_url = 'https://www.kidzania.jp'

target_url = 'https://www.kidzania.jp/corporate/news/'
max_row = 5
...
try:
    ...
    for i in range(1,100):
        xpath_str1 = '//*[@id="pageTop"]/div/main/div/div/div/ul[1]/li[' + str(i) + ']/span[1]'
        try:
            element_str1 = driver.find_element(by=By.XPATH,value=xpath_str1)
        except:
            break
        print(element_str1.get_attribute("outerHTML"),file=codecs.open(file_name,'a','utf-8'))
        xpath_str2 = '//*[@id="pageTop"]/div/main/div/div/div/ul[1]/li[' + str(i) + ']/a'
...
while True:
    ...
    result3 = re.search("target",line1)
