...
file_name = "dome" + date1 + ".txt"
out_file = "dome.txt"
string1 = '<div id="sideCallouts">'
date_str = ""
w_title = ""
base_url = 'https://www.domecorp.com/'
pdf_url = "https://www.domecorp.com/news/"
target_url = 'https://www.domecorp.com/news/' + date2 + "/"
max_row = 5
...
try:
    ...
    for i in range(1,81):
        ...
        xpath_str1 = ' //*[@id="mainArea"]/ul/li[' + str(i) + ']/span'
        ...
        xpath_str2 = '//*[@id="mainArea"]/ul/li[' + str(i) + ']/a'
...
while True:
    ...
    if result2:
        ...
        w_url = w_url.replace('"',"")
        result3 = re.search("pdf",w_url)
        if result3:
            w_url = w_url.replace("../","")
            w_url = pdf_url + w_url
        else:
            w_url = target_url + w_url
        #print(w_url)
        w_title = w_array2[1]
        w_title = w_title.replace("</a","")
        #print(w_title)
        key_word = key_word = r"(役員|取締役)"
