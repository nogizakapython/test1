...
file_name = "livedo" + date1 + ".txt"
out_file = "livedo.txt"
string1 = '<div id="sideCallouts">'
date_str = ""
w_title = ""
base_url = 'https://www.livedo.jp/'

target_url = 'https://www.livedo.jp/information/'
max_row = 5
...
try:
    ...
    for i in range(1,30):
        ...
        xpath_str1 = '//*[@id="stage"]/main/section/div[2]/a[' + str(i) + ']'
        try:
        ...
        #xpath_str2 = '//*[@id="stage"]/main/section/div[2]/a[' + str(i) + ']/div[1]/time'
        ...
        #xpath_str2 = '//*[@id="stage"]/main/section/div[2]/a[' + str(i) + ']/div[2]'
        #element_str2 = driver.find_element(by=By.XPATH,value=xpath_str2)
        #print(element_str2.get_attribute("outerHTML"),file=codecs.open(file_name,'a','utf-8'))    
...
while True:
    ...
    result2 = re.search("<time",line1)
    result3 = re.search("e-lbl",line1)
    if result1:
    ...
    if result3:
        ...
        #print(w_title)
        key_word = key_word = r"(人事|役員|就任)"
        result4 = re.search(key_word,w_title)
        if result4:
            wb = op.load_workbook(export_file)
            sh_name = 'LIVEDO CORPORATION'
            ws = wb[sh_name]
