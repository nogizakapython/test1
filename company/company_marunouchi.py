#######   企業HP 人事異動情報取得(丸の内キャピタル)　###########
#######   新規作成  2023/12/29  ##########
#######   修正      2024/1/16  HPの構造が変更になったため修正対応済み
...
file_name = "marunouchi" + date1 + ".txt"
out_file = "marunouchi.txt"
string1 = '<div id="sideCallouts">'
date_str = ""
w_title = ""
base_url = 'https://www.marunouchi-capital.com'
target_url = 'https://www.marunouchi-capital.com/news/'
max_row = 5
...
try:
    ...
    #    element = driver.find_element(By.XPATH,'//*[@id="n-content"]/div/div/div/div/a[2]')
    ...
    for i in range(1,21):
        xpath_str1 = '//*[@id="n-content"]/div/div/div/ul/li[' + str(i) + ']/a'
        xpath_str2 = '//*[@id="n-content"]/div/div/div/ul/li[' + str(i) + ']/a/p'
        xpath_str3 = '//*[@id="n-content"]/div/div/div/ul/li[' + str(i) + ']/a/h3'
...
while True:
    ...
    if result3:
        ...
        #print(w_title)
        key_word = key_word = r"(異動)"
        result4 = re.search(key_word,w_title)
        if result4:
            wb = op.load_workbook(export_file)
            sh_name = 'MARUNOUCHI CAPITAL CO. LTD.'
            ws = wb[sh_name]
