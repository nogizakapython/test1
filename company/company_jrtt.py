...
file_name = "jrtt" + date1 + ".txt"
out_file = "jrtt.txt"
string1 = '<div id="sideCallouts">'
date_str = ""
w_title = ""
base_url = 'https://www.jrtt.go.jp'

target_url = 'https://www.jrtt.go.jp/news/personnel/index.html'
max_row = 5
...
try:
    ...
    for i in range(1,50):
        ...
        xpath_str1 = '//*[@id="main"]/div[2]/div/div/div/div[1]/div/ul/li[' + str(i) + ']/time'
        ...
        xpath_str2 = '//*[@id="main"]/div[2]/div/div/div/div[1]/div/ul/li[' + str(i) + ']/a'
